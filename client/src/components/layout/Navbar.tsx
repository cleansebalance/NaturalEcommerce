...
const Navbar = () => {
  ...
  return (
    <nav className={`fixed w-full bg-white bg-opacity-80 z-50 transition-all duration-300 ${
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-20">
          ...
          <div className="flex items-center">
            ...
            <button className="p-2 rounded-full hover:bg-light transition-all duration-300 mr-2">
